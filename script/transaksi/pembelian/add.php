...
require "include/controller/pembelian.class.php";
	...
	<div class="panel-body">
            ...
            <div class="col-md-6 my-3">
              <form class="form" role="form" action="" method="POST" autocomplete="off">
                ...
                <div class="form-group row">
                  <label class="col-md-3 col-form-label form-control-label"> Nama Toko :</label>
                    <div class="col-md-9">
                ...
                <div class="hitung">          
                 <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label"> Quantity :</label>
                      <div class="col-lg-9">
                        <input class="form-control" type="number" id="jumlah" name="qty" placeholder=""  />
                      </div>
                </div>
                ...
                <div class="form-group row">
                  <label class="col-lg-3 col-form-label form-control-label"> Harga :</label>
                    <div class="col-lg-9">
                        <input class="form-control harga" type="textarea"   name="harga" placeholder="" />
                    </div>
                </div>
                <div class="form-group row">
                  <label class="col-lg-3 col-form-label form-control-label"> Total :</label>
                    <div class="col-lg-9">
                        <input class="form-control total" type="textarea" id="rupiah" name="harga" placeholder="" />
                    </div>
                </div>
              </div>
                <div class="form-group row">
